...
Перед настройкой интеграции убедитесь, что у вас есть:<br>
📌 Контроллер домена Active Directory (AD) с управлением групповыми политиками.<br>
📌 Установщик сенсора CrowdStrike Falcon (FalconSensor_Windows.exe).<br>
📌 Идентификатор клиента (CID) из консоли CrowdStrike Falcon.<br>
📌 Права администратора на контроллере домена.<br>
